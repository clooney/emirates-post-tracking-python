# Emirates Post Tracking API For Python
Emirates Post Tracking API and webhook make it easy to integrate Emirates Post Tracking function into your own project. Support APIs Client Libraries for python

### API key

In order to use this API, you need to generate a Emirates Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Emirates Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Emirates Post Tracking API](https://www.trackingmore.com/emirates-post-tracking.html)  to:

   *   Get Emirates Post realtime tracking info of muti-carriers in one integration
   *   Provide Emirates Post shipment tracking experience like Amazon
   *   Push Emirates Post notifications of package update with webhook
   *   Verify Emirates Post delivery exception before it is too late
